...
<div class="container">
  ...
  <form action="{{route('users.store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="pwd" placeholder="Enter moblile no" name="mobile">
       @error('mobile')
     {{$message}}
      @enderror
    </div>
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control" id="file" placeholder="Enter File" name="profile_pic">
       @error('file')
     {{$message}}
      @enderror
    </div>
